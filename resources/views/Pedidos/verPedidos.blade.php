...
<table class="table table-striped ">
  ...
  <tbody>
    <tr>
      ...
      <td class="text-center"><a href="/Pedidos/Download/{{ $p->id_pedido }}"><button class="btn btn-success" type="submit"><i class="fa fa-download" aria-hidden="true"></i> Editar</button></a></td>
